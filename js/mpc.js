...
(function() {
  $(function() {
    var PadTrigger, bongoPad12, bongoPad16, bongoPad8, context, deg, hihatPad2, hihatPad6, kickPad1, kickPad13, kickPad5, kickPad9, openHatPad14, recDeg, recordKnob, ridePad4, snarePad11, snarePad15, snarePad3, snarePad7, tambPad10, volDeg, volumeKnob, wheel;
    deg = 0;
    wheel = $('.wheel');
    ...
    return bongoPad16 = new PadTrigger("pad-16", "assets/samples/bongos/bongo_cr78_3.wav");
  });
